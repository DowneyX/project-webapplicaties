 ...
 */
final class Version20230320114524 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE faulty_measurement (id INT AUTO_INCREMENT NOT NULL, measurement_id INT NOT NULL, UNIQUE INDEX UNIQ_1F31436F924EA134 (measurement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE geolocation (id INT AUTO_INCREMENT NOT NULL, station_id VARCHAR(10) NOT NULL, country_code_id VARCHAR(10) NOT NULL, island VARCHAR(100) DEFAULT NULL, county VARCHAR(100) DEFAULT NULL, place VARCHAR(100) DEFAULT NULL, hamlet VARCHAR(100) DEFAULT NULL, town VARCHAR(100) DEFAULT NULL, municipality VARCHAR(100) DEFAULT NULL, state_district VARCHAR(100) DEFAULT NULL, administrative VARCHAR(100) DEFAULT NULL, state VARCHAR(100) DEFAULT NULL, village VARCHAR(100) DEFAULT NULL, region VARCHAR(100) DEFAULT NULL, province VARCHAR(100) DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, locality VARCHAR(100) DEFAULT NULL, postcode VARCHAR(100) DEFAULT NULL, country VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_9DC0E5B421BDB235 (station_id), INDEX IDX_9DC0E5B4EE96A67A (country_code_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE measurement (id INT AUTO_INCREMENT NOT NULL, station_id VARCHAR(10) NOT NULL, timestamp DATETIME NOT NULL, temperature DOUBLE PRECISION NOT NULL, dew_point DOUBLE PRECISION NOT NULL, station_air_pressure DOUBLE PRECISION NOT NULL, sea_level_air_pressure DOUBLE PRECISION NOT NULL, wind_speed DOUBLE PRECISION NOT NULL, precipitation DOUBLE PRECISION NOT NULL, snow_depth DOUBLE PRECISION NOT NULL, frshtt VARCHAR(6) NOT NULL, cloud_percentage DOUBLE PRECISION NOT NULL, wind_direction SMALLINT NOT NULL, visibility DOUBLE PRECISION NOT NULL, INDEX IDX_2CE0D81121BDB235 (station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nearest_location (id INT AUTO_INCREMENT NOT NULL, station_id VARCHAR(10) NOT NULL, country_code_id VARCHAR(10) NOT NULL, name VARCHAR(100) DEFAULT NULL, administrative_region1 VARCHAR(100) DEFAULT NULL, administrative_region2 VARCHAR(100) DEFAULT NULL, longitude DOUBLE PRECISION NOT NULL, latitude DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_F17FBE8C21BDB235 (station_id), INDEX IDX_F17FBE8CEE96A67A (country_code_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE faulty_measurement ADD CONSTRAINT FK_1F31436F924EA134 FOREIGN KEY (measurement_id) REFERENCES measurement (id)');
        $this->addSql('ALTER TABLE geolocation ADD CONSTRAINT FK_9DC0E5B421BDB235 FOREIGN KEY (station_id) REFERENCES station (id)');
        $this->addSql('ALTER TABLE geolocation ADD CONSTRAINT FK_9DC0E5B4EE96A67A FOREIGN KEY (country_code_id) REFERENCES country (id)');
        $this->addSql('ALTER TABLE measurement ADD CONSTRAINT FK_2CE0D81121BDB235 FOREIGN KEY (station_id) REFERENCES station (id)');
        $this->addSql('ALTER TABLE nearest_location ADD CONSTRAINT FK_F17FBE8C21BDB235 FOREIGN KEY (station_id) REFERENCES station (id)');
        $this->addSql('ALTER TABLE nearest_location ADD CONSTRAINT FK_F17FBE8CEE96A67A FOREIGN KEY (country_code_id) REFERENCES country (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE faulty_measurement DROP FOREIGN KEY FK_1F31436F924EA134');
        $this->addSql('ALTER TABLE geolocation DROP FOREIGN KEY FK_9DC0E5B421BDB235');
        $this->addSql('ALTER TABLE geolocation DROP FOREIGN KEY FK_9DC0E5B4EE96A67A');
        $this->addSql('ALTER TABLE measurement DROP FOREIGN KEY FK_2CE0D81121BDB235');
        $this->addSql('ALTER TABLE nearest_location DROP FOREIGN KEY FK_F17FBE8C21BDB235');
        $this->addSql('ALTER TABLE nearest_location DROP FOREIGN KEY FK_F17FBE8CEE96A67A');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D6499A1887DC');
        $this->addSql('ALTER TABLE user_role DROP FOREIGN KEY FK_2DE8C6A3A76ED395');
        $this->addSql('ALTER TABLE user_role DROP FOREIGN KEY FK_2DE8C6A3D60322AC');
        $this->addSql('DROP TABLE country');
        $this->addSql('DROP TABLE faulty_measurement');
